...
def on_weather_change(data):
    w_type = data.get('type', '')
    if "Pluvieux" in w_type or "Orageux" in w_type:
        # Inflation temporaire
        # Pour l'instant on log juste
        print(f"[ECONOMY] Météo ({w_type}) : La demande en parapluies augmente !")

bus.subscribe("WEATHER_CHANGE", on_weather_change)
